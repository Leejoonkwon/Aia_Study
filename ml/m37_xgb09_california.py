...
# 최상의 점수 :  0.9736263736263737
###########################################
# 최적의 매개변수 :  {'gamma': 1, 'learning_rate': 0.1, 
#              'max_depth': 3, 'min_child_weight': 1, 'n_estimators': 100, 'subsample': 1}
# 최상의 점수 :  0.9736263736263737
###########################################
# 최적의 매개변수 :  {'colsample_bytree': 0.5, 'gamma': 1, 
#              'learning_rate': 0.1, 'max_depth': 3, 'min_child_weight': 1, 'n_estimators': 100, 'subsample': 1}
# 최상의 점수 :  0.9736263736263737
###########################################
# 최적의 매개변수 :  {'colsample_bylevel': 1, 'colsample_bytree': 
#     1, 'gamma': 1, 'learning_rate': 0.1, 'max_depth': 3, 'min_child_weight': 1, 'n_estimators': 100, 'subsample': 1}
# 최상의 점수 :  0.9736263736263737
###########################################
# 최적의 매개변수 :  {'colsample_bylevel': 1, 'colsample_bynode': 1,
