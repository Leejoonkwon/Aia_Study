...
{'target': 1.0, 'params': {'colsample_bytree': 0.5, 
                           'max_depth': 6.0, 
                           'min_child_weight': 4.147294931401888, 
                           'reg_alpha': 6.061175408699406, 
                           'reg_lambda': 0.001, 
                           'subsample': 1.0}}
# StandardScaler() : 0.944400 
# MinMaxScaler() : 0.944400 
# RobustScaler() : 0.944400 
# QuantileTransformer() : 0.944400 
# PowerTransformer() : 0.944400 