...
# 로그 변환 결과 : 0.8946
# log 취하기
df['magnesium']= np.log1p(df['magnesium'])      # 로그 변환 결과 : 0.8419
df['alcalinity_of_ash']= np.log1p(df['alcalinity_of_ash'])          # 로그 변환 결과 : 0.7734
df['color_intensity']= np.log1p(df['color_intensity'])        # 로그 변환 결과 : 0.8946
