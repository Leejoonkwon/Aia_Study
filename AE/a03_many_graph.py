...
model_01.fit(x_train,x_train,epochs=5)

print("===================== node 4개 시작")
model_04.compile(loss='binary_crossentropy',optimizer='adam')
model_04.fit(x_train,x_train,epochs=5)

print("===================== node 16개 시작")
model_16.compile(loss='binary_crossentropy',optimizer='adam')
model_16.fit(x_train,x_train,epochs=5)

print("===================== node 32개 시작")
model_32.compile(loss='binary_crossentropy',optimizer='adam')
model_32.fit(x_train,x_train,epochs=5)

print("===================== node 64개 시작")
model_64.compile(loss='binary_crossentropy',optimizer='adam')
model_64.fit(x_train,x_train,epochs=5)

print("===================== node 154개 시작")
model_154.compile(loss='binary_crossentropy',optimizer='adam')
model_154.fit(x_train,x_train,epochs=5)
...
outputs= [x_test,output_01,output_04,output_16,output_32,
          output_64,output_154]
