...
print(x3_test.shape, x3_train.shape)    #(70, 2) (70, 2)
...
merge4 = Dense(2, activation='relu', name='mge2')(mergel)
merge5 = Dense(3, name ='mg3')(merge4)
last_output2 = Dense(1, name='last')(merge5)
...
hist = model.fit([x1_test, x2_test, x3_test],[y1_test,y2_test] ,epochs=10, batch_size=100,
