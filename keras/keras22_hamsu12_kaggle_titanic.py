...
x_train, x_test, y_train, y_test = train_test_split(x,y, train_size=0.8,shuffle=True ,random_state=94)
...
hist = model.fit(x_train, y_train, epochs=2000, batch_size=20, 
...
plt.grid()
plt.title('훈련량') #맥플러립 한글 깨짐 현상 알아서 해결해라 
plt.ylabel('loss')
plt.xlabel('epochs')
...
#2. MinMaxScaler
# loss : 0.
# acc 스코어 : 0.8282828282828283
# 걸린시간 : 63.75999879837036
##################
#3. StandardScaler
# loss : 0.9620940089225769
# acc 스코어 : 0.8080808080808081
# 걸린시간 : 62.55567169189453
##################
#4. MaxAbsScaler
# loss : 0.6103704571723938
# acc 스코어 : 0.7878787878787878
# 걸린시간 : 61.82119369506836
##################
#5. RobustScaler
# loss : 1.4106671810150146
# acc 스코어 : 0.7474747474747475
# 걸린시간 : 63.47385573387146
##################
#6. Sequential에서  함수형 모델로
# loss : 0.562932014465332
# acc 스코어 : 0.8212290502793296
# 걸린시간 : 24.542255640029907
