...
# hist = model.fit(x_train, y_train, epochs=10, batch_size=40, 
...
# model.save("./_save/keras23_2_save.model_iris.h5")
model = load_model("./_save/keras23_2_save.model_iris.h5")
#4.  평가,예측
...
# save 전
# loss : 0.570962131023407
# acc 스코어 : 1.0
# 걸린시간 : 1.387690544128418
# save 후 load 시
# loss : 0.570962131023407
# acc 스코어 : 1.0
# 걸린시간 : 0.8666222095489502
