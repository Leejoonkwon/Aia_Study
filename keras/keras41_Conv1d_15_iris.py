...
x_train = x_train.reshape(112, 4,1)
x_test = x_test.reshape(38, 4,1)
...
#                       save_best_only=True, 
#                       filepath="".join([filepath,'k25_', date, '_iris_', filename])
#                     )
...
#####Conv1d
# loss : 0.31076517701148987
# acc 스코어 : 0.8947368421052632
# 걸린 시간 : 3.9373562335968018
