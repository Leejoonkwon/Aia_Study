...
x_train = np.load('D:\study_data\_save\_npy\_train_x6.npy')
y_train = np.load('D:\study_data\_save\_npy\_train_y6.npy')
x_test = np.load('D:\study_data\_save\_npy\_test_x6.npy')
y_test = np.load('D:\study_data\_save\_npy\_test_y6.npy')
