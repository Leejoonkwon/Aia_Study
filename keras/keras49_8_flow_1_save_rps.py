...
# print(xydata[0][0],xydata[0][0].shape) # (2520, 150, 150, 3)
print(xydata[0][0].shape) # (500, 150, 150, 3)
print(xydata[0][1].shape) # (500, 3)
...
xy_df3 = test_datagen.flow(x_df,y_df,
                       batch_size=augument_size,shuffle=False)
np.save('D:/study_data/_save/_npy/keras49_8_train_x.npy',arr=xy_df3[0][0])
np.save('D:/study_data/_save/_npy/keras49_8_train_y.npy',arr=xy_df3[0][1])
