...
Amo2 = Amo1['종가']
# Amo1 = Amo1.reshape(1006,28)
# Sam1 = Sam1.reshape(1006,28)
# scaler = StandardScaler()
# scaler = MinMaxScaler()
# print(Amo1,Amo1.shape) #(1035, 7)
# print(Sam1,Sam1.shape) #(1035, 7)
# Amo1 = scaler.fit_transform(Amo1[[  '시가', '고가', '저가', '종가','year','month','day']])
# Sam1 = scaler.transform(Sam1[[ '시가', '고가', '저가','year','month','day']])
# print(Amo1,Amo1.shape) #(1035, 7)
# print(Sam1,Sam1.shape) #(1035, 7)
...
x2 = ccc[:,:-3]
# y = y.reshape(1006,)
# print(aaa[-1],aaa[-1].shape)  #  (1006, 5, 1, 7) # (N,row,)
# print(x1,x1.shape)  #   (1006, 2, 1, 7)
# print(x2,x2.shape)  #   (1006, 2, 1, 7)
# print(y,y.shape)   
#   (1006,) [350500 342500 342000 ... 160000 155000 157000] (1006,) [342000 328500 323500 ... 157000 153000 149500] (1006,)
...
print(x1_train.shape)   #   (756, 4, 1, 7)
print(x1_test.shape)    #   (252, 4, 1, 7)
print(x2_train.shape)   #   (756, 4, 1, 7)
print(x2_test.shape)    #   (252, 4, 1, 7)
print(y_train.shape)    #   (756, 3, 1)
print(y_test.shape)    #   (252, 3, 1)


x1_train = x1_train.reshape(756,4,7)
x1_test = x1_test.reshape(252,4,7)
x2_train = x2_train.reshape(756,4,7)
