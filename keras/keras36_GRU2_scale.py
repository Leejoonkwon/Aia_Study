...
from tensorflow.python.keras.layers import Dense,SimpleRNN,Dropout,GRU#이름부터 간단?
...
#2. 모델구성
model = Sequential()
model.add(GRU(units=100, input_length=3,input_dim=1,activation='swish')) #위와 같은 개념
